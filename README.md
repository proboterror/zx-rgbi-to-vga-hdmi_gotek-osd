...
- Реализовано экранное меню для настроек (VGA/HDMI)
...
Кнопка вызова меню: GP 28.<br>
Кнопки навигации по меню: GP 26/27.

При смене разрешения производится перезапуск.<br>
При нажатии кнопки UP если не в меню циклическая смена HDMI на VGA 640х480 с установкой флага отмены авто определения типа монитора.

Включена поддержка WAVESHARE_RP2040_ZERO по умолчанию.<br>
Для WAVESHARE_RP2040_ZERO Gotek SDA/SCL пины изменены с 26/27 на 18/19.
